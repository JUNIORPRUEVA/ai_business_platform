export type BotDetectedRole = 'unknown' | 'lead' | 'customer' | 'owner' | 'manager' | 'operator' | 'cashier' | 'finance';
export type BotDetectedIntent = 'greeting' | 'product_question' | 'catalog_search' | 'pricing_inquiry' | 'billing_question' | 'order_status' | 'support_request' | 'configuration_request' | 'human_handoff' | 'unknown';
export type BotSelectedAction = 'answer_directly' | 'use_ai' | 'use_tool' | 'escalate';
export type BotPromptStrategy = 'direct-template' | 'knowledge-grounded-ai' | 'tool-assisted-ai' | 'safe-escalation';
